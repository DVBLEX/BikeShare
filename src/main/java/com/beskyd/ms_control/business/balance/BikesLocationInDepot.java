...
@Entity
@Table(name = "bikes_location_in_depot")
@Getter
@Setter
@EqualsAndHashCode
@ToString
@NoArgsConstructor
@AllArgsConstructor
public class BikesLocationInDepot implements JsonAware{
    ...
    private Timestamp in_storage_since;
    ...
    public JSONObject toJSONObject() {
        ...
        jo.put("in_storage_since", in_storage_since);
        return jo;
    }
}
